...
# Typical shelf life in days, by ingredient category
SHELF_LIFE_DAYS = {
    "leafy_greens": (3, 5),
    "berries": (3, 6),
    "dairy": (5, 10),
...
def assign_expiry_dates(ingredients: list[str], detected_on: date | None = None) -> dict[str, date]:
    ...
    for ing in ingredients:
        ...
        shelf_life = random.randint(low, high)
